...
Cumulative totals, year to date, with percentage change from 2020 to 2021.  Note that the number of months included this year depends on the most recent data update, which may be different for Fatal Encounters and the Washington Post.  So we present these separately.

```{r wavsus, warning=F}
fe_tab <- fe_940 %>% 
  filter(homicide==1 & year > 2018) %>% 
