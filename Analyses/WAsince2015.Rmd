...
Here we report the annual totals up through the last complete year --  `r last_complete_yr` -- with data from the Washington Post data only, since the Fatal Encounters project stopped updating at the end of 2021.  While we have updated data for WA state using the Fatal Encounters inclusion criteria (Fatal Encounters included all persons who are killed by police -- including deaths due to asphyxiation, tasers, vehicle chases, etc -- while Washington Post data only include persons shot and killed by police), there are no comparable data available for other states.
...
# Can't use FE b/c we don't have national data after 2021
# fe_tab <- fe_data %>% 
...
pop2024 <- read_csv("https://www2.census.gov/programs-surveys/popest/datasets/2020-2024/state/totals/NST-EST2024-ALLDATA.csv") %>%
